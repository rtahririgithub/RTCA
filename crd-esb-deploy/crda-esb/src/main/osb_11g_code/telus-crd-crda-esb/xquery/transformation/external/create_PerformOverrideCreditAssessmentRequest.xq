...
declare namespace xf = "http://tempuri.org/telus-crd-crda-esb/xquery/transformation/external/create_PerformOverrideCreditAssessmentRequest/";
...
declare function xf:create_PerformOverrideCreditAssessmentRequest($overrideCreditWorthiness1 as element(ns8:overrideCreditWorthiness),
    ...
    as element(ns1:performCreditAssessment) {
        ...
        <ns1:creditAssessmentRequest xsi:type="ent:OverrideCreditAssessmentRequest">
            ...
            }
            {
                ...
                return
                    <ns1:newCreditValueCd>{ data($newCreditValueCd) }</ns1:newCreditValueCd>
            }
            {
                for $newFraudIndictorCd in $overrideCreditWorthiness1/ns8:overrideCreditWorthinessRequest/ns8:newFraudIndictorCd
                return
                    <ns1:newFraudIndicatorCd>{ data($newFraudIndictorCd) }</ns1:newFraudIndicatorCd>                    
            }            
            {
...
xf:create_PerformOverrideCreditAssessmentRequest($overrideCreditWorthiness1,
