...
(:: pragma bea:global-element-parameter parameter="$assessCreditWorthinessResponse1" element="ns6:assessCreditWorthinessResponse" location="../../../wsdls/WLNCreditProfileManagementProxyServiceRequestResponse_v2_0.xsd" ::)
...
declare function xf:create_UpdateCustomerRequest($getCustomerResponse1 as element(ns0:getCustomerResponse),
    $assessCreditWorthinessResponse1 as element(ns6:assessCreditWorthinessResponse),
        ...
        <ns0:updateCustomer>
            {
                ...
                return
                    <customer>
                        ...
                        {
                            for $creditValueCd in $assessCreditWorthinessResponse1/ns6:assessedCreditWorthiness/ns5:creditValueCd
                            return
                                <creditValueCode>{ data($creditValueCd) }</creditValueCode>
                        }
                        {
...
declare variable $assessCreditWorthinessResponse1 as element(ns6:assessCreditWorthinessResponse) external;
declare variable $auditInfo1 as element() external;

xf:create_UpdateCustomerRequest($getCustomerResponse1,
    $assessCreditWorthinessResponse1,
    $auditInfo1)