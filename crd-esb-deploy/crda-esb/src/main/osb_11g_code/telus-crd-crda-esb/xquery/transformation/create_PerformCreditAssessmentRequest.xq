...
declare namespace xf = "http://tempuri.org/telus-crd-crda-esb/xquery/transformation/create_PerformCreditAssessmentRequest/";
...
declare function xf:create_PerformCreditAssessmentRequest($assessCreditWorthiness1 as element(ns8:assessCreditWorthiness),
    ...
    as element(ns1:performCreditAssessment) {    
        <ns1:performCreditAssessment>
            {           
            <ns1:ExistingCustomerCreditAssessmentRequest>
...
xf:create_PerformCreditAssessmentRequest($assessCreditWorthiness1,
