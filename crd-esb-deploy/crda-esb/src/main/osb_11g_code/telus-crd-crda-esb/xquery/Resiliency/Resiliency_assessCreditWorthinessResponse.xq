...
(:: pragma bea:global-element-return element="ns2:assessCreditWorthinessResponse" location="../../wsdls/WLNCreditProfileManagementProxyServiceRequestResponse_v2_0.xsd" ::)
...
declare namespace xf = "http://tempuri.org/telus-crd-crda-esb/xquery/Resiliency_assessCreditWorthinessResponse/";

declare function xf:Resiliency_assessCreditWorthinessResponse($consumerCreditProfile1 as element())
    as element(ns2:assessCreditWorthinessResponse) {
        <ns2:assessCreditWorthinessResponse>
            {
                let $creditWorthiness := $consumerCreditProfile1/ns1:creditWorthiness
                return
                    <ns2:assessedCreditWorthiness>
...
xf:Resiliency_assessCreditWorthinessResponse($consumerCreditProfile1)