...
public class UpdateCreditWorthinessImpl {
    		...
    		throws PolicyException, ServiceException
    {
        ...
        try {
			...
			listCreditAttribute = this.setCreditAttributes(creditAssessmentTransactionResult, 
	        		origCreditValue);
			...
			CreditValue creditValue) throws PolicyException 
	{
		...
		if (log.isDebugEnabled())
			log.debug("Old Credit Report Indicator: " + creditProfile.isCreditReportIndicator());
		...
		if (creditAssessmentTransactionResult.getCreditAssessmentDate() != null ) {
			...
			if (log.isDebugEnabled())
				log.debug("Credit Assessment Date : " + 
						creditAssessmentTransactionResult.getCreditAssessmentDate().toString());
			...
			if (log.isDebugEnabled()) {
				log.debug("original credit value code : " + creditProfile.getCreditValue().getCreditValueCode());
				log.debug("credit value code after assessment : " + 
						creditAssessmentTransactionResult.getCreditDecisioningResult().getCreditValueCd());
			}
