...
public class EnvUtil {
	public static String environmentFile_Folder="src/test/resources";
	public static String appCtxpropertiesFile_Folder= "src/test/resources";	
	
	public static String appCtxpropertiesFileName="appCtx_WLNCrdPrflMgtWs.properties";	
