...
import com.telus.credit.service.dto.CreditProfileMappingDto;
...
public class CreditProfileMapDaoSqlmap extends AbstractSqlMapDao implements CreditProfileMapDao
{
     ...
     */
	 ...
	 public void insertCreditProfileMap(CreditProfileMappingDto profileMap) throws DuplicateKeyException
	 {
	...
	/**
	  ...
	  * </ol>
	  */
	   public void expireBusinessOwnership(CreditProfileMappingDto creditProfileMap)
