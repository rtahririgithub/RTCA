...
{   
	private static final String INSERT_CREDITSTATUS_STMT = "credit_profile.insertCreditStatus";
	private static final String UPDATE_CREDITSTATUS_STMT = "credit_profile.updateCreditStatus";
	private static final String UPDATE_CREDITPROFILE_BY_STATUS_STMT = "credit_profile.updateCreditProfileByStatus";
