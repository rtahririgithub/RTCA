package com.telus.credit.testUtil;
import java.io.File;
...
public class EnvUtil {
	public static String environmentFile_Folder="src/test/resources/conf";
	public static String appCtxpropertiesFile_Folder= "src/test/resources/conf";	
	
	public static String appCtxpropertiesFileName="appCtx-OrderDep.properties"; 
