...
public class FicoTestRequestResponseMarshallingUtil {
	...
	public static DepositCalculatorRequest createDepositCalculatorRequest( String  xmlfilename) throws JAXBException, XMLStreamException, IOException {	
	 	String nodeName = "DepositCalculatorRequest";
	 	DepositCalculatorRequest re = (DepositCalculatorRequest)createRequestCommon(xmlfilename, nodeName, DepositCalculatorRequest.class);
	      
	      return re;
	  }
	
	public static DepositEquipmentRequest createDepositEquipmentRequest( String  xmlfilename) throws JAXBException, XMLStreamException, IOException {	
	 	String nodeName = "DepositEquipmentRequest";
	 	DepositEquipmentRequest re = (DepositEquipmentRequest)createRequestCommon(xmlfilename, nodeName, DepositEquipmentRequest.class);
    ...
    public static Object createRequestCommon(String xmlFilename,String nodeName,Class clazz ) throws JAXBException, XMLStreamException, IOException {	
    	String requestStr =  FicoTestRequestResponseMarshallingUtil.readFileToString(new File(xmlFilename));
