...
/FIELDS req_id1 1: - 1: ASCII 
/FIELDS credit_vu 2: - 2:
/FIELDS pd_bolt_on 3: - 3:
/FIELDS ass_msg 4: - 4:
/FIELDS fraud 5: - 5:
/FIELDS risk_lvl_num 6: - 6:
/JOINKEYS req_id1


/OUTFILE $CRDA_OUTPUT_FILE 65535  OVERWRITE
/REFORMAT leftside:req_id,customer_id,customer_st_cd,create_user_id,data_source_id,create_ts,cat_type_cd,cat__sub_type_cd,customer_ct_dt,bypass,f_nm,m_nm,l_nm,address_l1,address_l2,address_l3, address_l4,address_l5,city,prov,country,post_cd,sub_pv_cd,cust_type_cd,report_sc,sin,dl,dl_pv,passport,passport_ct,pov_id,pov_pv,health_id,health_pv,employm,resident,prim_cr,second_cr,legal_care,dob,sim,crd_score,crd_class,crd_decision,crd_msg,create_date,coll_segment,scorecard_id,cycles_delinq,rightside:credit_vu,pd_bolt_on,ass_msg,fraud,risk_lvl_num
