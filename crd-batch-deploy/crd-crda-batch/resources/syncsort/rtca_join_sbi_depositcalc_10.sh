...
/FIELDS totalMonthlyChargeAmt 2: - 2:
/FIELDS totalprevAssessedDepAmt 3: - 3:
/FIELDS totalAssessedDepAmt 4: - 4:

/JOINKEY depositCalcId

/OUTFILE $CRDA_OUTPUT_FILE 65535 OVERWRITE
/REFORMAT leftside:file1_orderDepId,file1_customerId,file1_orderId,file1_decisionCd,file1_totalARDepPaidAmt,file1_lastARDepPaidTS,file1_totalDepReleasedAmtTot,file1_lastARDepARDepReleasedTS,file1_totalARDepPendingAmt,file1_lastARDepPendingTS,file1_DepAdjAmt,file1_DepOnHandAmt,file1_finaldepamtass,file1_CalcRsltMsgCd,file1_CalcRsltReasonCd,stv_reqrentedCount,stv_reqpurchasedCount,stv_ownedCount,stv_rentedCount,dsl_reqrentedCount,dsl_reqpurchasedCount,dsl_ownedCount,dsl_rentedCount,ttv_reqrentedCount,ttv_reqpurchasedCount,ttv_ownedCount,ttv_rentedCount,sl_reqrentedCount,sl_reqpurchasedCount,sl_ownedCount,sl_rentedCount,forborneInd,RIGHTSIDE:totalMonthlyChargeAmt,totalprevAssessedDepAmt,totalAssessedDepAmt
