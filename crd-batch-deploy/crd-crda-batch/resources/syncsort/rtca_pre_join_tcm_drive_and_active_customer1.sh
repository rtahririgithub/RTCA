...
# Filename: rtca_pre_join_tcm_drive_and_active_customer1.sh
...
if [ $# -eq 3 ]; then
    ...
    echo ""
    echo "usage:rtca_pre_join_tcm_drive_and_active_customer1.sh  [input file1] [input file2]  [output file] "
