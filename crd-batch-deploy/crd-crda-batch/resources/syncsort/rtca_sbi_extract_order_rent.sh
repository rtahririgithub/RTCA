...
# Filename: rtca_sbi_extract_order_rent.sh  
...
if [ $# -eq 2 ]; then
    ...
    echo ""
    echo "usage:rtca_sbi_extract_order_rent.sh  [input file1] [output file] | noskip"
...
/FIELDS rentedEquipCount 5: - 5:EN
/FIELDS purchasedEquipCount 6: - 6:
...
/CONDITION isRented(orderPrdStatCd = "A" )

/SUMMARIZE TOTAL rentedEquipCount

/INCLUDE isRented
/OUTFILE $CRDA_OUTPUT_FILE 65535 OVERWRITE
/REFORMAT depositCalcId , serviceTypCd , rentedEquipCount
