...
/CONDITION isProdQual(credApprvdProdCatCd != "" )

/INCLUDE isProdQual
/OUTFILE $CRDA_OUTPUT_FILE 65535 OVERWRITE
/REFORMAT carId, credValCd,decisionCd,prodCategoryBoltOn,assessmentMsgCd,fraudMsgCd,prodQualInd,credApprvdProdCatCd
