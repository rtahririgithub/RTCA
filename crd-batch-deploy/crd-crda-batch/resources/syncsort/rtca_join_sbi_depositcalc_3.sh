...
/FIELDS file2_ownedCount 3: - 3:en

/JOINKEY file2_orderDepId, file2_serviceTypCd

/OUTFILE $CRDA_OUTPUT_FILE 65535 OVERWRITE
/REFORMAT leftside:file1_orderDepId,file1_serviceTypCd,file1_reqRentedCount ,file1_reqPurchased,RIGHTSIDE:file2_ownedCount
