...
/FIELDS file1_rentedEquipCount 3: - 3:en
...
/FIELDS file2_purchasedEquipCount 3: - 3:en
/JOINKEY file2_orderDepId, file2_serviceTypCd

/OUTFILE $CRDA_OUTPUT_FILE 65535 OVERWRITE
/REFORMAT file1_orderDepId,file1_serviceTypCd,file1_rentedEquipCount,file2_purchasedEquipCount
