...
#ls $DATA_FILE|sed -e '/\.[1-9][0-9]*\./s/[^.]*\.//' -e '/[1-9][0-9]*\./s/.dat//' -e '/\.[1-9][0-9]*$/s/.*\.//'|read AUD_CREATION_DATE 
ls $DATA_FILE|sed -e '/\.[1-9][0-9]\{7\}.*\./s/[^.]*\.//' -e '/[1-9][0-9]\{7\}.*\./s/.dat//' -e '/\.[1-9][0-9]\{7\}.*$/s/.*\.//'|read AUD_CREATION_DATE
