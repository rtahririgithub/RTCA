...
/**
 * Parses the Toll Only Long Distance (LD) CLOB records.
 * 1. Retrieves the value of the "externalSn" property of the above product from the CLOB.
 * 2. Retrieves the value of the "clec" property of the above product from the CLOB.
 *
 * @author Damian Etarsky
 */
public class LongDistanceClobParser {
    ...
    */
   public LongDistanceClobParser(String inputFilename, String outputFilename, String parameterOne,
                                 String parameterTwo, int bufferSize, int fieldSize, String clobDelimiter,
    ...
    *
    * Goal: parse the value associated with the "externalSn" property name
    * Input: externalSn+value;clec+value;key(n)+value(n);
    * Output: the value associated with the "externalSn" property name
    *
