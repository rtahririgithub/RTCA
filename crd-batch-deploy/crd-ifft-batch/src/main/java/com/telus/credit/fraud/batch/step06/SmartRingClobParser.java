...
/**
 * Parses the Smart Ring (SN) CLOB records.
 * 1. Retrieves the value of the "subscriptionNumber" property of the above product from the CLOB.
 *
 * @author Damian Etarsky
 */
public class SmartRingClobParser {
    ...
    */
   public SmartRingClobParser(String inputFilename, String outputFilename, String parameterOne, String parameterTwo,
