 ...
 * 
 * <p>
 * <b>Description: </b> This batch loads customerIds and profileIds into memory from splited files done by previous step,
 *  process them to get a list of customer group and output the list to another file for next step.
 * </p>
 * <p>
 * <b>Design Observations: </b>
 * </p>
 * <ul>
 * <li>this batch will take the whole input file as a LUW in order to process the whole set of data to get a list of customer group.</li>
 * </ul>
 * 
 * <p>
 * <br>
 ...
 *  
 */
public class ExtractCustomerGroupBatch implements Module
{
    private static final Log log = LogFactory.getLog( ExtractCustomerGroupBatch.class );
    ...
    public boolean hasNext() throws ModuleException
    {
    	...
    	if (!m_hasNext)
    	{
			...
			{   
				...
				if (group.getCustomerIds()!=null)
				    m_pWriter.println(group.getCustomerIds());
			} 
    	}
    	return m_hasNext;
    }
    ...
    public void launch(BatchContext batchContext) throws ModuleException
    {
        try {
            ...
            //System.out.println("ProfileMap is " +this.m_profileMap);
            load(m_inputFileSortByCustomerId,this.m_customerMap);
            //System.out.println("CustomerMap is "+this.m_customerMap);
	 ...
	 * type=0, load data into profile hashMap
	 * type=1, load data into customer hashMap
	 * */
	private void load(String filePath,HashMap dataMap) throws ModuleException
	{
		String record;
		String keyId=null;
		String valueId=null;
...
//		    switch (type)
//			{     
//		       case 0: dataMap=this.m_profileMap;
//			   case 1: dataMap=this.m_customerMap;
//			     
//			}    
...
//		    
	...
	protected void findRecursive(CustomerGroup customerGroup,String customerId)
	{   
	    String[] profileArray;
...
//        }
	...
	public void setCustomerMap(HashMap customerMap) {
		m_customerMap = customerMap;
	}
	
	/**
	 * @return Returns the customerMap.
	 */
	...
	/**
	 * @return Returns the processedResultSet.
	 */
	public HashSet getProcessedResultSet() {
		return m_processedResultSet;
	}
	
	
	/**
	 * @param processedResultSet The processedResultSet to set.
	 */
	public void setProcessedResultSet(HashSet processedResultSet) {
		m_processedResultSet = processedResultSet;
	}
}
