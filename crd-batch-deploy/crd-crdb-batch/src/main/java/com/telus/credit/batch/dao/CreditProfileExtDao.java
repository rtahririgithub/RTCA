...
public interface CreditProfileExtDao
{
    ...
    /**
     * <p>
     * <b>Description: </b> Updates CreditProfileExt in the data store with the new
     ...
     */
    public void updateCreditProfileExt(CreditProfile creditProfile, String userId, Integer sourceId, boolean profc, boolean cvupdate) 
    throws ConcurrencyConflictException;
    /**
